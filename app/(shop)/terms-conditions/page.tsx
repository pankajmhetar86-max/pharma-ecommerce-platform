  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 lg:px-6">
      ...
      <div className="space-y-6 text-slate-600">
        <p>
          By accessing or using secure.77pharmacy.com, you agree to be bound by these Terms &amp; Conditions. If you do
        ...
        <div>
          ...
          <p>
            ...
            secure.77pharmacy.com and is protected by applicable intellectual property laws. Unauthorized reproduction
